 ...
 */
public class KioskHomePage extends WebPage {
    private static final long serialVersionUID = 1L;

    private final IModel<String> amount = Model.of("100.00");
    private final IModel<String> result = Model.of("");

    public KioskHomePage() {
        add(new Label("appName", "BranchDesk — Kiosk"));
    ...
    private void withdraw(String amountText) {
        ...
        config.setDeviceMode(com.meridianbranch.branchdesk.model.DeviceMode.KIOSK);
        ...
        result.setObject("Available balance: " + withdrawal.getDisplayedBalance().toPlainString());
    }
}
